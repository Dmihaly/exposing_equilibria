"This module is created to build MPEC with quanity bids, for all UL agents,
Definitation of which UL problem is being built is based on the 'current' string passed in"
function build_MPEC_quantity(t_steps, non_str_gens, non_str_res, current, optimizer, objective_type)
